...
export default function ResultCard({ disease = "---", confidence = "---", details = null }) {
    ...
    <View style={styles.container}>
      ...
      {details && !isHealthy && (
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailSection}>
            <Text style={[styles.detailLabel, { color: "#DC3545" }]}>💊 সমাধান:</Text>
            <Text style={styles.detailText}>{details.treatment}</Text>
          </View>


          <View style={styles.detailSection}>
            <Text style={[styles.detailLabel, { color: "#0B8457" }]}>🛡️ প্রতিরোধ:</Text>
...
const styles = StyleSheet.create({
  ...
  textGroup: { flex: 1 },
  label: { fontSize: 11, color: "#6C757D", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  detailLabel: { fontSize: 13, fontWeight: "bold", color: "#495057", marginBottom: 3 },
